...
contract FlarensteinBears is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, ERC721PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    // Address of the flarensteinBearsToken ERC20 token contract
    address public flarensteinBearsToken;
  ...
  // Array and mappings for blacklist management
    ...
    function initialize(address initialOwner, address _flarensteinBearsToken) initializer public {
        __ERC721_init("FlarensteinBears", "FBEARS");
        ...
        flarensteinBearsToken = _flarensteinBearsToken; // Set the address of the Psycho Gems ERC20 token contract
        nonce = 0;
    }
    ...
    if (msg.sender != owner()) {
       ...
       referrals[referralCode].push(msg.sender);
                ...
                IERC20(flarensteinBearsToken).transfer(msg.sender, refereeReward);
