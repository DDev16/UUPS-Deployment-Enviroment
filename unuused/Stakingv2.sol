...
contract ChoaticCreationsStaking is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(IERC20 _rewardsToken, ERC721EnumerableUpgradeable _nftCollection) public initializer {
        __Ownable_init();
